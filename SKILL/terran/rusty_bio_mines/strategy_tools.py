"""Resource-free tool package for the rusty_bio_mines strategy.

Derived from ``dummies/terran/rusty_bio_mines.py``. Resource-spending tools such
...
class RustyBioMinesStrategyTools(BuildOrder):
    """Rusty bio mines tools that do not spend minerals, gas, or supply."""
