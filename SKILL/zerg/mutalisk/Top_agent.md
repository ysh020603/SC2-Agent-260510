...
Spend excess minerals on Drones, Queens, Zerglings, Overlords, and a third Hatchery while preserving gas for Mutalisks. If the enemy masses Marines or static anti-air, keep the Mutalisks alive for map control and add Banelings or Roaches on the ground. Continue air upgrades and Mutalisk production only while the fleet can find economic damage; otherwise transition the established economy into a durable ground army.
