...
{new_line.join(builds.keys())}
        ...
        parser.add_argument(
            ...
            choices=(
                ...
                "human-skill-full-v8",
                "human-skill-full-v9",
                "human-skill-full-v10",
                "human-skill-full-v11",
                "human-skill-full-v12",
                "human-skill-full-v13",
                "human-skill-full-v14",
                "human-skill-full-v15",
                "human-skill-full-v16",
                "human-skill-full-v17",
                "human-skill-full-v18",
                "human-skill-full-v5",
                "human-skill-full-v4",
                "human-skill-full-v3",
                "human-skill-full-v2",
