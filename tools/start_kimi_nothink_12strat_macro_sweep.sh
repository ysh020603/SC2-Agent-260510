...
# All modules: Kimi-k2.5 (no thinking)
#
# Usage:
#   bash tools/start_kimi_nothink_12strat_macro_sweep.sh
# Resume: CONCURRENCY=2 SKIP_COMPLETED=1 bash tools/start_kimi_nothink_12strat_macro_sweep.sh
...
SESSION="${TMUX_SESSION:-kimi_nothink_12strat_macro_sweep}"
...
echo "=================================================="
echo " Started : kimi_nothink (all modules)"
echo " Tmux    : $SESSION"
