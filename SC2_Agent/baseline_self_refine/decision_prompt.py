"""Shared naive-equivalent domain prompt for Self-Refine.
...
Output exactly one JSON object when asked for a replacement queue:
...
def build_decision_context(
    ...
    **_extra: Any,
    ...
    """Build the frozen domain context shared by Init / Feedback / Refine."""
