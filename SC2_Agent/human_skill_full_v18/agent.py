...
class HumanSkillFullV18Agent(HumanSkillAgent):
    """V16-stable execution with a generic late-game throughput closer."""

    def __init__(self, **kwargs):
        skill = kwargs.get("skill")
        if skill is None:
            raise ValueError("full-v18 requires a loaded skill")
        super().__init__(
