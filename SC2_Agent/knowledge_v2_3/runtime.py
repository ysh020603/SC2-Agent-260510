"""Provider-independent V2.3 text-completion invocation."""
...
class V2TraceRecorder(TraceRecorder):
    schema_version = "sc2-agent-trace-v2.3"
    ...
    def __call__(
        ...
        *,
        ...
        request_payload: dict[str, Any] = {
            ...
            "messages": messages,
            "invocation_protocol": "portable_text_v1",
            "tool_names": [],
        }
        if tools:
            raise ValueError(
                "V2.3 never sends provider-native tools; execute repository tools "
                "through the portable local orchestrator instead."
            )
