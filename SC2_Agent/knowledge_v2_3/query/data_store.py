...
# V2.3 owns its query/runtime implementation and prompts, while reusing the
# immutable repository release already copied for V2.  Keeping one physical
# dataset avoids another ~100 MB copy without coupling either version's code.
DEFAULT_DATASET_DIR = ROOT_DIR.parent / "knowledge_v2_2_v2" / "data_sc2_260701"
