        ...
        for main_round in range(MAX_MAIN_ROUNDS):
            ...
            if normalized in asked:
                ...
                try:
                    ...
                    session = {
                        "session_id": f"unavailable-{main_round}",
                        "main_round": main_round,
                        "question": question,
                        ...
                        "observations": [],
                        "status": "unavailable",
                        "answer_source": "orchestrator_failure_fallback",
                        "reply": {
                            "answer": "Repository knowledge is temporarily unavailable; preserve the last executable plan and use deterministic live-state constraints.",
                            "confidence": "low",
                            "entities_mentioned": [],
                            "candidate_entities": [],
                            "evidence_summary": "No external evidence was available.",
                            "limitations": [f"{type(exc).__name__}: {exc}"],
                        },
                    }
                    self.recorder.record("sub_session_degraded", {
                        "main_round": main_round,
                        "error": f"{type(exc).__name__}: {exc}",
                        "fallback": "continue_mainagent_with_unavailable_evidence",
                    })
