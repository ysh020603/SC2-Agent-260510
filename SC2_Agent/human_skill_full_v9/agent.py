...
class HumanSkillFullV9Agent(HumanSkillAgent):
    """V7 branch-faithful routing with executability taught, not enforced."""

    def __init__(self, **kwargs):
        skill = kwargs.get("skill")
        if skill is None:
            raise ValueError("full-v9 requires a loaded skill")
        super().__init__(
